"""
Django settings for weather_bridge project.
...
SECRET_KEY = 'django-insecure-=fvernypnew7!-2yv)r1-b%)q$9ejz6c8g5*1f)w%xye(#5eld'
...
ROOT_URLCONF = 'weather_bridge.urls'
...
WSGI_APPLICATION = 'weather_bridge.wsgi.application'
...
#  Check if the key was loaded (helps during development)
